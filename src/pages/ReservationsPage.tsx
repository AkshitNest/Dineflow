...
import { getReservationWithRestaurantDetails, updateReservationStatus } from '@/store/reservationData';
...
const ReservationsPage: React.FC = () => {
  ...
  // Get user reservations if user exists
  const reservations = user ? getReservationWithRestaurantDetails(user.id) : [];
